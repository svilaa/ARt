...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorCorrectionCurves : PostEffectsBase
	{
        ...
        void CheckShaders()
        {
            ...
            {
                simpleColorCorrectionCurvesShader = (Shader)Resources.Load("Shaders/ColorCorrectionCurvesSimple");
            }

            if (colorCorrectionCurvesShader == null)
            {
                colorCorrectionCurvesShader = (Shader)Resources.Load("Shaders/ColorCorrectionCurves");
            }

            if (colorCorrectionSelectiveShader == null)
            {
                colorCorrectionSelectiveShader = (Shader)Resources.Load("Shaders/ColorCorrectionSelective");
            }
        }
        ...
        public override bool CheckResources ()
		{
            ...
            // Added because shaders are not loaded in runtime by default
            CheckShaders ();
